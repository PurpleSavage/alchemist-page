...
export default function End() {
  return (
    <section className={`h-screen  overflow-hidden relative ${style.gradient} `}>
        ...
        <div className={` ${style.circleLeft} bg-black w-[1400px] shadow-lg shadow-yellow-800/50 
         h-[1400px] overflow-hidden flex gap-10 z-10`}>
            <div className={`w-[100px] h-full ${style.barGradient} `}></div>
            <div className={`w-[100px] h-full ${style.barGradient} `}></div>
            <div className={`w-[100px] h-full ${style.barGradient} `}></div>
            <div className={`w-[100px] h-full ${style.barGradient} `}></div>
        </div>
        <div className={` ${style.circleRight} bg-black w-[1400px] h-[1400px] shadow-lg shadow-yellow-800/50 
