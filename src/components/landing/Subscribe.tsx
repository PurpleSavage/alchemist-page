...
export default function Subscribe() {
  return (
    <section className='overflow-hidden relative  mx-auto w-full md:w-[80%]   min-h-screen '>
        ...
        right-0 top-0 z-10 gap-16'>
            <h2 className='text-2xl px-2  text-center md:text-5xl font-bold'>Regístrate y forma parte de Alchemist</h2>
            <SubscribeForm/>
        </div>
    </section>
  )
